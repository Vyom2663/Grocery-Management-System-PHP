   ...
   <section class="home-category">
      ...
      <div class="box-container">
         ...
         <div class="box">
            ...
            <h3>Milk Products</h3>
            <p>Want some milk products??</p>
            <a href="category.php?category=fish" class="btn">Milk Products</a>
         </div>
      ...
      <div class="box-container">
         ...
         ?>
               <form action="" class="box" method="POST">
                  <div class="price">Rs.<span><?= $fetch_products['price']; ?></span><?php if ($fetch_products['category'] === ("milk-products") ) {
                     echo "\ L";
                  }
                  else {
                     echo "\ KG";
